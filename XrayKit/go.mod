module github.com/mekhriddin/V2RaySabLab/XrayKit
...
// gomobile constraint: only types in this module's API are exported to Swift.
// Keep the surface tiny (see xraykit.go).
